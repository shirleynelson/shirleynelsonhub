...
def main():
    ...
    rate = data["rates"]["USD"]
    print(f"2 EUR is equal to {rate} USD")
    rate = data["rates"]["GBP"]
    print(f"3 EUR is equal to {rate} GBP")
    rate = data["rates"]["AUD"]
    print(f"4 EUR is equal to {rate} AUD")
    rate = data["rates"]["PLN"]
    print(f"5 EUR is equal to {rate} PLN")
    rate = data["rates"]["MXN"]
    print(f"6 EUR is equal to {rate} MXN")
